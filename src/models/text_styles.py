...
class TextOutline(BaseModel):
    ...
    model_config = ConfigDict(json_schema_extra={"example": {"enabled": True, "color": "#FFFFFF", "width": 2}})
...
class TextBackgroundBox(BaseModel):
    ...
    model_config = ConfigDict(
        json_schema_extra={"example": {"enabled": True, "color": "#000000", "opacity": 0.8, "padding": 15}}
    )
...
class TextElementStyle(BaseModel):
    ...
    # Optional effects
    shadow: TextShadow | None = Field(default=None, description="Drop shadow configuration")
    outline: TextOutline | None = Field(default=None, description="Text outline configuration")
    background: TextBackgroundBox | None = Field(default=None, description="Background box configuration")
...
class TextCustomization(BaseModel):
    ...
    headline: TextElementStyle | None = Field(default=None, description="Headline styling")
    subheadline: TextElementStyle | None = Field(default=None, description="Subheadline styling")
    cta: TextElementStyle | None = Field(default=None, description="CTA styling")
