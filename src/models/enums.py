...
class Product(BaseModel):
    ...
    existing_assets: dict[str, str] | None = Field(
        default=None, description="Paths to existing assets (hero, logo, etc.)"
    )
    generation_prompt: str | None = Field(default=None, description="Custom prompt for image generation")
